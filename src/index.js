    ...
    render() {
        ...
        return (
            <div>
                ...
                <Grid columns={1}>
                    <Grid.Column>
                        <Button icon='angle double right' size='massive' onClick={() => this.setState({ visible: true })} color='blue'/>
    ...
    render() {
        return (
            <div>
                <div class='table'>
                    <link rel="stylesheet" type="text/css" href="index.css"></link>
                    <Table unstackable color='grey' textAlign='center'>
                        <Table.Header>
                            <Table.Row as='tr'>
        ...
        return (
            <div>
                ...
                <div class= 'prevbutton'>  
                    <Button onClick={() => this.nextSchedule(-1)} floated='left' color='blue' size='huge'>Prev</Button>
                </div>  
                <div class= 'nextbutton'>  
                    <Button onClick={() => this.nextSchedule(1)} floated='right' color='blue' size='huge'>Next</Button>
                </div>
